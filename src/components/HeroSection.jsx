        ...
        {socialLinks.map((link, index) => (
          link.name === 'Resume' ? (
            ...
            >
              ...
              <span className="text-xs font-inter font-medium">CV</span>
            </a>
          ) : (
          <motion.a
            key={link.name}
          ...
          >
            {link.name === 'GitHub' && (
              ...
              <span className="text-xs font-inter font-medium">GitHub</span>
              </>
            )}
            {link.name === 'LinkedIn' && (
              <>
              ...
              <span className="text-xs font-inter font-medium">LinkedIn</span>
              </>
            )}
            {link.name === 'Medium' && (
              <svg className="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24">
